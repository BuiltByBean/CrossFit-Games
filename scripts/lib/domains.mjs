...
export const NAME_RULES = [
  ...
  [/1rm|1-rm|one rep|total\b|max\b|deadlift ladder|clean ladder|snatch ladder/i, { strength: 0.85, weightlifting: 0.15 }],
  ...
  [/handstand|hspu|muscle-up|muscle up|pull-up|pullup|ring|bar\b|toes-to-bar|ghd|midline|legless|inverted/i, { gymnastics: 0.7, grip: 0.2, skill: 0.1 }],
  ...
  [/snatch|clean|jerk|thruster|squat|press|lift|barbell|grace|isabel|elizabeth|fran|diane|dt\b|jackie/i, { weightlifting: 0.6, strength: 0.2, endurance: 0.2 }],
